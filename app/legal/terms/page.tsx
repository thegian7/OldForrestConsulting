  ...
  return (
    ...
    >
      ...
      <section id="acceptance" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">1. Acceptance of Terms</h2>
      ...
      <section id="services" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">2. Services Description</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section id="use-license" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">3. Use License</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section id="user-conduct" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">4. User Conduct</h2>
        <p className="text-ink-2 mb-4">
          You agree not to:
        </p>
        <ul className="list-disc list-inside text-ink-2 space-y-2">
      ...
      <section id="disclaimer" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">6. Disclaimer</h2>
        <div className="bg-cream-2 p-6 rounded-lg">
          <p className="text-ink-2 mb-4 font-medium">
      ...
      <section id="limitation" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">7. Limitation of Liability</h2>
        <div className="bg-cream-2 p-6 rounded-lg">
          <p className="text-ink-2 mb-4 font-medium">
      ...
      <section id="indemnification" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">8. Indemnification</h2>
        <p className="text-ink-2">
      ...
      <section id="termination" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">9. Termination</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section id="governing-law" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">10. Governing Law</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section id="changes" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">11. Changes to Terms</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section id="contact" className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">12. Contact Information</h2>
        <p className="text-ink-2 mb-4">
          If you have any questions about these Terms, please contact us:
        </p>
        <div className="bg-cream-2 p-6 rounded-lg">
          <p className="text-forest-deep font-semibold mb-2">Old Forrest Consulting LLC</p>
          <p className="text-ink-2">Email: contact@oldforrest.net</p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-forest-deep mb-4">Additional Provisions</h2>

        <h3 className="text-xl font-semibold text-forest-deep mt-6 mb-3">Entire Agreement</h3>
        <p className="text-ink-2 mb-4">
        ...
        <h3 className="text-xl font-semibold text-forest-deep mt-6 mb-3">Severability</h3>
        <p className="text-ink-2 mb-4">
          If any provision of these Terms is found to be unenforceable, the remaining
          provisions will continue in full force and effect.
        </p>

        <h3 className="text-xl font-semibold text-forest-deep mt-6 mb-3">Waiver</h3>
        <p className="text-ink-2 mb-4">
          No waiver of any term of these Terms shall be deemed a further or continuing
          waiver of such term or any other term.
        </p>

        <h3 className="text-xl font-semibold text-forest-deep mt-6 mb-3">Assignment</h3>
        <p className="text-ink-2">
